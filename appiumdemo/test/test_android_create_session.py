...
from appiumdemo.test.helpers_util import take_screenhot_and_logcat, ANDROID_APP_PATH, EXECUTOR
...
class TestAndroidSelectors(unittest.TestCase):
    ...
    def test_should_create_and_destroy_android_session(self):
        ...
        self.assertEquals('io.appiumdemo.android.apis.ApiDemos', '{}{}'.format(pkg, activity))
        self.driver.quit()
